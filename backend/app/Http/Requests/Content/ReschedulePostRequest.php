...
final class ReschedulePostRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        // Post must be in SCHEDULED status to reschedule
        if ($post->status !== PostStatus::SCHEDULED) {
            return false;
        }

        // Tenant admins can reschedule any post
        if ($user->isAdmin()) {
            return true;
        }
        ...
        // Only admins/owners can reschedule posts
